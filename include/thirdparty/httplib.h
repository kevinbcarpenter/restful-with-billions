...
// KBC
inline void Request::setId(unsigned int id) const { id_ = id; }

inline unsigned int Request::id() const { return id_; }
// KBC
...
// KBC
inline void Response::setId(unsigned id) const { id_ = id; }

inline unsigned Response::id() const { return id_; }
// KBC
